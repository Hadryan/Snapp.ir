...
/***********************************************************************************************************************
 index action for getting driver location on trip

 inputs : DeviceId , UserId , TripId
 outputs : result:(true or false) if result true Data is onlineDriver object
...
exports.index = function(req, res) {
    ...
    lib.async.auto({
        findUser: function(callBack, results){
	        repository.drivers.getDriverLocation(body ,function(result){
        ...
        if(result.findUser.Result == false) {
            ...
            res.status(200).json({Result: true, Data: [result.findUser.data]});
        }
    });
};
/***********************************************************************************************************************
